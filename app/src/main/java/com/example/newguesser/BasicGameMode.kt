...
private const val TAG = "BasicGameModeActivity"

class BasicGameMode : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_basic_game_mode)
            ...
            if (submitButton.text == "Next Question" || submitButton.text == "Nachste Frage") {
                ...
                if (similarity >= 0.7) {
                    ...
                    if (attemptedQuestions.size + attemptedDbQuestions.size < maxQuestions) {
                        ...
                        var db = GuesserDatabaseHelper(this)
                        var ifDataInserted = db.addScore(userName, userScore, null)
